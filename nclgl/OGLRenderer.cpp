...
void OGLRenderer::SetShaderLight(const Light& l) {
	...
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "type"), l.GetType());

}

void OGLRenderer::SetShaderLight(const SpotLight& sl) {
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "lightPos"), 1, (float*)&sl.GetPosition());
	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "lightColour"), 1, (float*)&sl.GetColour());
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "lightRadius"), sl.GetRadius());
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "Dirction"), 1, (float*)&sl.GetDirction());
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "Cutoff"), sl.GetCutoff());
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "OuterCutoff"), sl.GetOuterCutoff());
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "type"), sl.GetType());

}

void OGLRenderer::SetShaderLight(const DirctionLight& dl) {
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "lightPos"), 1, (float*)&dl.GetDirction());
	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "lightColour"), 1, (float*)&dl.GetColour());
	glUniform1f(glGetUniformLocation(currentShader->GetProgram(), "type"), dl.GetType());
